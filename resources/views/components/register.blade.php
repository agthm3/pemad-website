                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form action="{{ route('register') }}" method="post">
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label">Company Address</label>
                            ...
                            <div class="mb-3">
                                <label for="password" class="form-label">Bank Info</label>
                                <select value="" name="bank_name" class="form-control mb-2">
                                    <option name="bank_name" value="Mandiri" id="">Mandiri</option>
                                    <option name="bank_name" value="BCA" id="">BCA</option>
                                    <option name="bank_name" value="BNI" id="">BNI</option>
                                    <option name="bank_name" value="Danamon" id="">Danamon</option>
                                    <option name="bank_name" value="BRI" id="">BRI</option>
                                    <option name="bank_name" value="BTN" id="">BTN</option>
                                </select>
                                <input type="number" name="bank_number" placeholder="Bank Account Number"
