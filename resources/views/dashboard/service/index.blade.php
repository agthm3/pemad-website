    ...
    <section class="d-flex flex-column gap-4">
        ...
        <div class="d-flex gap-4 flex-wrap">
            <div class="product-card">
                <img src="./assets/images/englishindonesia.jpg" alt="Nike Red" width="260" height="180" />
                <div class="product-detail pt-3">
                    <div>
                        <p class="label-detail mb-1">7 Reviews</p>
                        <p class="title-detail">English - Indonesian</p>
                    </div>
            ...
            <div class="product-card">
                <img src="./assets/images/frenchindonesia.jpg" alt="Nike Red" width="260" height="180" />
                <div class="product-detail pt-3">
                    <div>
                        <p class="label-detail mb-1">7 Reviews</p>
                        <p class="title-detail">French - Indonesian</p>
                    </div>
                    <button class="btn btn-fav active" aria-label="Button Favorite" onclick="handleFavorite(this)">
                        <svg fill="currentColor">
                            <path
                ...
                <div class="product-detail pt-4">
                    ...
                    <button class="buy-product button btn-rounded active" onclick="handleBuy(this)">
                        Manage
                    </button>
                </div>
            </div>
