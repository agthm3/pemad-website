                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                              ...
                              standards established by international standards."
                                            ...
                                            <tr>
                                                <td>Price</td>
                                                <td>
                                                    <input type="text " placeholder="Rp220.000" class="form-control" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="" class="btn btn-danger mt-2 mb-2">Remove</a>
                            ...
                            <div class="col-lg-12">
                                <button class="col-lg-12 btn btn-primary float-rigth mt-2 mb-2 float-rigth">
                                    Save
                                </button>
                            </div>
                        </div>
